...
| 用户已按 `disclosure_builder.md` §7.6 声明侧重点，仅需 **第七章权利要求书式强化**（取向须与本稿已有材料及第七、五章已写观点一致，**禁止**为交互而编造新场景） | `merger.md`（以最近定稿为基准，合并范围以第七章为主，必要时微调第六章与第七章衔接句） |
...
- 合并或纠正后的全文写入**新文件**，不得默认覆盖旧稿：  
  **`{规范化案件名}_{YYYYMMDDHHmmss}.md`** + **`build_docx.py` 生成的同名 `.docx`**。  
